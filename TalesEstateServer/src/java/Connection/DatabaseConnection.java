...
//        }
        ...
        try {
            ...
            connectionURL = "jdbc:sqlserver://10.0.0.102:1433;databaseName=TalesProd;integratedSecurity=true";
    ...
    public Connection openConnectionEstate() {
        ...
        try {
            connectionURL = "jdbc:sqlserver://10.0.0.102:1433;databaseName=TalesEstate;integratedSecurity=true";
            d = (Driver) Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance();
            con = d.connect(connectionURL, new Properties());
        } catch (Exception e) {
