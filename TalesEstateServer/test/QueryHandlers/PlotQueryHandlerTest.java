...
public class PlotQueryHandlerTest extends TestCase {
     ...
     *
     * *Note: This function will remain unimplemented because we do not want to
     * delete a plot every time we test.
     */
    ...
    /**
     * Test of addPlotAccess method, of class PlotQueryHandler. **Note: The
     * following 3 test must follow each other in succession.
     *
     * Test 1st of 3
     */
    ...
    public void testGetAllOutstandingRequests() {
        ...
        PlotQueryHandler instance = new PlotQueryHandler(con);
        ArrayList<String[]> result = instance.getAllOutstandingRequests();
        String[] one = result.get(0);
        boolean correct = false;
