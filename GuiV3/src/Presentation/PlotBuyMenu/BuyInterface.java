package Presentation.PlotBuyMenu;
...
public class BuyInterface extends BasePanel {
    ...
    public BuyInterface(String buy, int JFXPANEL_WIDTH_INT, int JFXPANEL_HEIGHT_INT, UserCharacter Pchar, GuiV3 aThis, CardLayout cardlayout, Container contentPane) {
        super(buy);
        user = Pchar;
        applet = aThis;
        layout = cardlayout;
    ...
    public void init(final int JFXPANEL_WIDTH_INT, final int JFXPANEL_HEIGHT_INT) {
        ...
        BuyMenuPicturePanel picmenu = null;
        picmenu = new BuyMenuPicturePanel(adapter.ImageAdapter(10), JFXPANEL_WIDTH_INT, JFXPANEL_HEIGHT_INT);
